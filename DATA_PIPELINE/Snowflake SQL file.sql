 CREATE OR REPLACE STORAGE INTEGRATION PBI_Integration
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::211125504521:role/powerbi.role'
  STORAGE_ALLOWED_LOCATIONS = ('s3://raajpowerbi.project/')
...
CREATE database RPowerBI;

create schema RPBI_Data;

create table RPBI_Dataset (
...
select * from RPBI_DATASET;

//drop database test;

create stage RPBI_Data.pbi_stage
url = 's3://raajpowerbi.project'
...
SELECT YEAR,COUNT (*) COUNT FROM RPBI_DATASET GROUP BY YEAR ORDER BY YEAR 
